...
class MonitorCardAdmin(admin.ModelAdmin):
    ...
    list_editable = ("show_on_monitor", "display_order", "normal_color")
    list_filter = ("show_on_monitor", "reference_exchange", "compare_exchange", "normal_color")
...
class MonitorSettingsAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("last_synced_at", "telegram_last_summary_at")
...
class MarketQuoteAdmin(admin.ModelAdmin):
    list_display = ("symbol", "display_symbol", "reference_exchange", "gap_percent", "status", "fetched_at")
